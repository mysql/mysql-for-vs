...
namespace MySql.Data.MySqlClient.Design
{
	...
	[GuidAttribute("7756F17D-640A-4DBA-A452-A38523DB2FBC"), ProgId("MySql.Data.MySqlClient.Design.Connect")]
...
//			addInInstance = (AddIn)addInInst;
			...
			windowToolWindow = applicationObject.Windows.CreateToolWindow (addInInstance, "MySql.Data.MySqlClient.Design.ServerExplorer", "Connector/.NET", mysqlPro, ref objTemp);
		...
		internal TableViewer CreateTableViewer( string caption)
		{
			object temp = null;
//			string guid = "{E4824B63-1122-467a-B8BC-8934F9A7CE00}";
			Window editor = applicationObject.Windows.CreateToolWindow (addInInstance, "MySql.Data.MySqlClient.Design.TableViewer", caption, Guid.NewGuid().ToString("B"), ref temp);
