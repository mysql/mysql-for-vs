...
{
  /// <summary>
  /// Defines a factory for <see cref="CollectionTestsProperties"/> based classes.
  /// </summary>
  public static class CollectionTestsPropertiesFactory
  {
    /// <summary>
    ...
    public static CollectionTestsProperties GetCollectionTestsProperties(ScriptLanguageType language)
    {
      switch (language)
      {
        case ScriptLanguageType.JavaScript:
          return new JsCollectionTestsProperties(language);

        case ScriptLanguageType.Python:
          return new PyCollectionTestsProperties(language);
