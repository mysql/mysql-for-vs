...
namespace MySql.Data.MySqlClient.SQLGeneration
{
    /// <summary>
    ...
    internal static class DmlSqlGenerator
    {
        ...
        private class ExpressionTranslator : DbExpressionVisitor
        {
            ...
            internal MySqlParameter CreateParameter(object value, TypeUsage type)
            {
            ...
            internal MySqlParameter CreateParameter(object value, DbType dbType)
            {
            ...
            {
                MySqlParameter parameter = CreateParameter(expression.Value, expression.ResultType);
