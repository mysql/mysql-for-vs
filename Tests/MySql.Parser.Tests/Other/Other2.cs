...
namespace MySql.Parser.Tests.Other
{
  public class Other2
  {
    ...
    public void Test4()
    {
      string sql = @"	CREATE TABLE app_recipe ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , author_id INTEGER NOT NULL , name VARCHAR( 10 ) NOT NULL , insert_date datetime NOT NULL , batch_size NUMERIC( 1 , 2 ) NOT NULL , batch_size_units VARCHAR( 10 ) NOT NULL , style_id INTEGER NULL , derived_from_recipe_id INTEGER NULL , type VARCHAR( 10 ) NOT NULL , source_url VARCHAR( 10 ) NULL , notes LONGTEXT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test6()
    {
      string sql = @"	CREATE TABLE auth_permission ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL , content_type_id INTEGER NOT NULL , codename VARCHAR( 10 ) NOT NULL , UNIQUE ( content_type_id , codename ) ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test9()
    {
      string sql = @"	SELECT thresholds0_ . rule_id AS rule5_1_ , thresholds0_ . threshold_id AS threshold1_1_ , thresholds0_ . threshold_id AS threshold1_22_0_ , thresholds0_ . level AS level22_0_ , thresholds0_ . value AS value22_0_ , thresholds0_ . variable AS variable22_0_ FROM rule_thresholds thresholds0_ WHERE thresholds0_ . rule_id = 1";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test10()
    {
      string sql = @"	ALTER TABLE django_admin_log AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test12()
    {
      string sql = @"	ALTER TABLE app_hop AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test16()
    {
      string sql = @"	ALTER TABLE app_adjunct AUTO_INCREMENT = 2 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test19()
    {
      string sql = @"	ALTER TABLE auth_user_user_permissions AUTO_INCREMENT = 3 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test20()
    {
      ...
      string sql = @"	CREATE TABLE app_grain ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL , extract_min SMALLINT NULL , extract_max SMALLINT NULL , volume_potential_min SMALLINT NULL , volume_potential_max SMALLINT NULL , lovibond_min SMALLINT NULL , lovibond_max SMALLINT NULL , description VARCHAR( 10 ) NOT NULL , `group` VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test24()
    {
      string sql = @"	CREATE TABLE auth_user ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , username VARCHAR( 10 ) NOT NULL UNIQUE , first_name VARCHAR( 10 ) NOT NULL , last_name VARCHAR( 10 ) NOT NULL , email VARCHAR( 10 ) NOT NULL , password VARCHAR( 10 ) NOT NULL , is_staff bool NOT NULL , is_active bool NOT NULL , is_superuser bool NOT NULL , last_login datetime NOT NULL , date_joined datetime NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test26()
    {
      string sql = @"	ALTER TABLE app_yeast AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test27()
    {
      string sql = @"	CREATE TABLE app_brew ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , brew_date datetime NULL , brewer_id INTEGER NOT NULL , notes LONGTEXT NULL , recipe_id INTEGER NULL , last_update_date datetime NULL , last_state VARCHAR( 10 ) NULL , is_done bool NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test28()
    {
      string sql = @"	CREATE TABLE app_userprofile ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , user_id INTEGER NOT NULL UNIQUE , pref_brew_type VARCHAR( 10 ) NOT NULL , pref_make_starter bool NOT NULL , pref_secondary_ferm bool NOT NULL , pref_dispensing_style VARCHAR( 10 ) NOT NULL , timezone VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    {
      // group identifier is not valid in this context
      string sql = @"	CREATE TABLE app_adjunct ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL , `group` VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test33()
    {
      string sql = @"	CREATE TABLE django_site ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , domain VARCHAR( 10 ) NOT NULL , name VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test36()
    {
      string sql = @"	CREATE TABLE app_yeast ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , manufacturer_id INTEGER NOT NULL , ident VARCHAR( 10 ) NOT NULL , name VARCHAR( 10 ) NOT NULL , description VARCHAR( 10 ) NOT NULL , type VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test37()
    {
      string sql = @"	ALTER TABLE south_migrationhistory AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test39()
    {
      string sql = @"	CREATE TABLE app_step ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , brew_id INTEGER NOT NULL , type VARCHAR( 10 ) NOT NULL , date datetime NOT NULL , entry_date datetime NOT NULL , volume NUMERIC( 1 , 2 ) NULL , volume_units VARCHAR( 10 ) NULL , temp INTEGER NULL , temp_units VARCHAR( 10 ) NULL , gravity_read NUMERIC( 1 , 2 ) NULL , gravity_read_temp INTEGER NULL , gravity_read_temp_units VARCHAR( 10 ) NULL , notes VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test40()
    {
      string sql = @"	ALTER TABLE django_content_type AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test42()
    {
      string sql = @"	ALTER TABLE app_recipe AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test46()
    {
      string sql = @"	ALTER TABLE app_style AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test50()
    {
      string sql = @"	ALTER TABLE app_recipehop AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test51()
    {
      string sql = @"	CREATE TABLE app_hop ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL , aau_low NUMERIC( 1 , 2 ) NOT NULL , aau_high NUMERIC( 1 , 2 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test52()
    {
      string sql = @"	ALTER TABLE auth_group_permissions AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test54()
    {
      string sql = @"	ALTER TABLE auth_permission AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test55()
    {
      string sql = @"	SHOW FULL TABLES FROM mem LIKE 'a'";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test56()
    {
      string sql = @"	ALTER TABLE app_yeastmanufacturer AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test57()
    {
      string sql = @"	ALTER TABLE app_starredrecipe AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test59()
    {
      string sql = @"	CREATE TABLE app_recipehop ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , recipe_id INTEGER NOT NULL , hop_id INTEGER NOT NULL , amount_value NUMERIC( 1 , 2 ) NOT NULL , amount_units VARCHAR( 10 ) NOT NULL , boil_time SMALLINT NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test66()
    {
      string sql = @"	ALTER TABLE app_brew AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test67()
    {
      string sql = @"	ALTER TABLE app_recipeyeast AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test72()
    {
      string sql = @"	CREATE TABLE django_session ( session_key VARCHAR( 10 ) NOT NULL PRIMARY KEY , session_data LONGTEXT NOT NULL , expire_date datetime NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test75()
    {
      string sql = @"	ALTER TABLE auth_group AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test78()
    {
      string sql = @"	CREATE TABLE app_yeastmanufacturer ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test79()
    {
      string sql = @"	ALTER TABLE app_grain AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test81()
    {
      string sql = @"	CREATE TABLE app_recipeadjunct ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , recipe_id INTEGER NOT NULL , adjunct_id INTEGER NOT NULL , amount_value NUMERIC( 1 , 2 ) NOT NULL , amount_units VARCHAR( 10 ) NOT NULL , boil_time SMALLINT NOT NULL , notes VARCHAR( 10 ) NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test83()
    {
      string sql = @"	ALTER TABLE auth_user AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test86()
    {
      string sql = @"	ALTER TABLE django_site AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test88()
    {
      string sql = @"	CREATE TABLE app_recipegrain ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , recipe_id INTEGER NOT NULL , grain_id INTEGER NOT NULL , amount_value NUMERIC( 1 , 2 ) NOT NULL , amount_units VARCHAR( 10 ) NOT NULL , by_weight_extract_override SMALLINT NULL , by_volume_extract_override SMALLINT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test96()
    {
      string sql = @"	CREATE TABLE app_style ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL , bjcp_code VARCHAR( 10 ) NOT NULL , parent_id INTEGER NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test105()
    {
      ...
      string sql = @"	CREATE TABLE app_starredrecipe ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , recipe_id INTEGER NOT NULL , user_id INTEGER NOT NULL , `when` datetime NOT NULL , notes VARCHAR( 10 ) NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test108()
    {
      string sql = @"	ALTER TABLE app_step AUTO_INCREMENT = 10 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test109()
    {
      string sql = @"	ALTER TABLE app_recipeadjunct AUTO_INCREMENT = 20 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test110()
    {
      string sql = @"	ALTER TABLE auth_message AUTO_INCREMENT = 30 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test111()
    {
      string sql = @"	CREATE TABLE django_content_type ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL , app_label VARCHAR( 10 ) NOT NULL , model VARCHAR( 10 ) NOT NULL , UNIQUE ( app_label , model ) ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test113()
    {
      string sql = @"	ALTER TABLE auth_user_groups AUTO_INCREMENT = 1 ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test115()
    {
      string sql = @"	CREATE TABLE south_migrationhistory ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , app_name VARCHAR( 10 ) NOT NULL , migration VARCHAR( 10 ) NOT NULL , applied datetime NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test117()
    {
      string sql = @"	CREATE TABLE django_admin_log ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , action_time datetime NOT NULL , user_id INTEGER NOT NULL , content_type_id INTEGER NULL , object_id LONGTEXT NULL , object_repr VARCHAR( 10 ) NOT NULL , action_flag SMALLINT UNSIGNED NOT NULL , change_message LONGTEXT NOT NULL ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    public void Test118()
    {
      string sql = @"	CREATE TABLE auth_group ( id INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR( 10 ) NOT NULL UNIQUE ) ;";
      Utility.ParseSql(sql, false);
    }
    ...
    {
      // Missing semicolon
      string sql = @"	SHOW CREATE PROCEDURE barC518;";
      Utility.ParseSql(sql, false);
      sql = @" SHOW CREATE TRIGGER a";
      Utility.ParseSql(sql, false);
    }
