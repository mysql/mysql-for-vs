...
namespace MySql.Parser.Tests.Other
{
  public class GatheringTables
  {
    ...
    {
      Utility.ParseSql("INSERT INTO test6.d_table VALUES (1);");
    }
    ...
    {
      Utility.ParseSql("INSERT INTO test6.d_table ( col ) VALUES (1);");
    }

    [Fact]
    public void SelectWithTableExtraction()
    {
      Utility.ParseSql("select * from test6.d_table;");
    }

    [Fact]
    public void SelectWithTableExtraction2()
    {
      Utility.ParseSql("select * from test6.d_table as T;");
    }

    [Fact]
    public void SelectWithTableExtraction3()
    {
      Utility.ParseSql("select * from d_table as T;");
    }

    [Fact]
    public void SelectWithTableExtraction4()
    {
      Utility.ParseSql("select * from d_table;");
    }
  }
}
