...
`user_id` = 'XXX', `page` = '/', `lastview` = NOW();");
    ...
    {
      string result = Utility.ParseSql(@"replace into employees PARTITION (p3) VALUES (20, 'Jan', 'Jones', 1, 3);", true, new Version(5, 5, 0));
    ...
    {
      Utility.ParseSql(@"replace into employees PARTITION (p3) VALUES (20, 'Jan', 'Jones', 1, 3);", false, new Version(5, 6, 31));
    }
  }
}
