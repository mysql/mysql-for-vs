...
namespace MySql.Parser.Tests.DDL.Alter
{
  public class AlterEvent
  {
    ...
    public void Simple1()
    {
      Utility.ParseSql(@"ALTER EVENT no_such_event ON SCHEDULE EVERY '2:3' DAY_HOUR;", false);
    }
    ...
    public void Simple7()
    {
      // ToDo: MYSQLFORVS-612 - This should be working, as stated here: http://dev.mysql.com/doc/refman/5.5/en/alter-event.html
      // Utility.ParseSql(@"ALTER EVENT olddb.myevent RENAME TO newdb.myevent;", false, new Version(5, 7, 12));
    }
  }
}
