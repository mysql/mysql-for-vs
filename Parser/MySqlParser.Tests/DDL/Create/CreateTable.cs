...
namespace MySqlParser.Tests.Create
{
	[TestFixture]
	public class CreateTable
	{
		...
		public void Simple()
		{
			MySQL51Parser.statement_list_return r = Utility.ParseSql("CREATE TABLE T1 ( id int, name varchar( 20 ) )");
		}
...
default character set = utf8, checksum = 1, collate = 'latin1', comment = 'A test script',
